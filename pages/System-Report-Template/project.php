          ...
          <div class="card" id="printTable">
            ...
            <div class="card-body pb-0">
              <div class="row invoive-info d-pdrint-inline-flex justify-content-md-center">
                ...
                <div class="col-md-6">
                  <h5 class="m-b-10 text-primary text-uppercase">PROJECTS REPORT</h5>
                </div>
              </div>
              <div class="row">
                  ...
                  <div class="table-responsive">
                    <table class="table invoice-detail-table">
                      ...
                      <tbody>
                        <tr>
                          <td width="150">HRM</td>
                          <td width="200">	aniket nangare</td>
                          <td><span class="text-warning">2022.06.16</span></td>
                          <td>2022.06.16</td>
                          <td>1:VEDANT NAIDU</td>
                          <td>High</td>
                          <td>0%</td>
                        </tr>
                        ...
                        <tr>
                          <td width="150">HRM</td>
                          <td width="200">aniket nangare</td>
                          <td><span class="text-warning">2022.06.20</span></td>
                          <td>2022.06.23</td>
                          <td>1:Divya Gupta</td>
                          <td>High</td>
                          <td>0%</td>
