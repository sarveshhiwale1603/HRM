          ...
          <div class="card" id="printTable">
            ...
            <div class="card-body pb-0">
              <div class="row invoive-info d-pdrint-inline-flex justify-content-md-center">
                ...
                <div class="col-md-6">
                  <h5 class="m-b-10 text-primary text-uppercase">Attendance Month</h5>
                    ...
                    <table class="table invoice-detail-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td width="200">2022-06-01</td>
                          <td><span class="text-warning">Holiday</span></td>
                          <td>No work schedule</td>
                          <td></td>
                        </tr>
                                                                    
                        <tr>
                          <td width="150">Thursday</td>
                          <td width="200">2022-06-30</td>
                          <td><span class="text-warning">Holiday</span></td>
                          <td>No work schedule</td>
                          <td></td>
                        </tr>
