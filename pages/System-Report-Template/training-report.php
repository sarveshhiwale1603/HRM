          ...
          <div class="card" id="printTable">
            ...
            <div class="card-body pb-0">
              <div class="row invoive-info d-pdrint-inline-flex justify-content-md-center">
                ...
                <div class="col-md-6">
                  <h5 class="m-b-10 text-primary text-uppercase">TRAINING REPORT:</h5>
                  <h6 class="text-uppercase text-primary m-l-30"> <strong>From : 2022.06.11   To : 2022.06.11</strong> </h6>
                </div>
              </div>
              <div class="row">
