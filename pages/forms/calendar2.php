        ...
        <div class="col-md-4 grid-margin">
          <div class="card-body">
              <div class="d-flex flex-row align-items-start">
                  ...
                  <div class="ms-3">
                    <h6 ><a href="calendar2.php" target="_self" style="text-decoration:none">Calendar
                    </a></h6>
                    <p>Leave Calendar</p>
                  </div>
              </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div id="external-events">
                    ...
                    <div class="external-event bg-info">Approve</div>
                    <div class="external-event bg-danger">Rejected</div>
