          ...
          <div class="col-md-3">
            <div class="sticky-top mb-3">
              <div class="card">
                ...
                <div class="card-body">
                  <!-- the events -->
                  <div id="external-events"> <div class="external-event bg-primary">Not Started
                  </div>
                  <div class="external-event bg-info">In Progress
                  </div>
                  <div class="external-event" style="background-color: rgba(131, 166, 236, 0.71);">Do homework</div>


                  <div class="external-event bg-warning">Completed</div>
                  <div class="external-event bg-danger">Cancelled </div>
                  <div class="external-event bg-success">On Hold
                  </div>
                  </div>
                </div>
                <!-- /.card-body -->
