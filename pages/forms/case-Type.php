              ...
              <div class="col-lg-12 col-sm-12">
                    ...
                    <div class="row my-3">
                        <div class="col-md-4">
                            <div class="card">
                              ...
                              <div class="card-footer">
                                <buttton type="button" id="submit" class="btn btn-lg btn-primary"
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">List All Case Types</h5>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <div id="caseType_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <table id="caseType" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="caseType_info">
                                                <thead>
                                                 <tr>
                                                 <th><i class="fas fa-braille"></i>CASE TYPE</th>
                                                 <th>CREATED AT</th>
    ...
    <script>
      $(function () {
        $("#caseType")
          ...
          .buttons()
          .container()
          .appendTo("#caseType_wrapper .col-md-6:eq(0)");
        $("#example2").DataTable({
          paging: true,
          lengthChange: false,
          searching: false,
