            ...
            <div class="card-body">
              <div class="row py-0 my-0">
                <div class="col-sm-12 py-0 my-0">
                   <a href="project-Details.html"> <p class="task-detail py-0 my-0">
                        mnkjnknkjn...</p></a>
                    <p class="task-due py-0 my-0"><small class="label text-muted label-primary">
                            completed 0%</small></p>
                </div>
                <div class="col-sm-12">
                ...
                <div class="task-list-table">
                  <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top"
                      title="" data-original-title="VEDANT NAIDU"><span class="mb-1"><img
                              ...
                              style=" border-radius: 50%; width: 35px; height: auto;"
                              alt=""></span>
              </div>
            </div>
            </div>
            <div class="card-footer"  style="text-align: center;">
              <a href="project-Grid.html">Add Project</a>
           </div>
        </div>
